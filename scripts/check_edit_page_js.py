...
def main() -> int:
    ...
    required_fragments = [
        ...
        'id="subtitle-text-inspector"',
        'data-inspector-mode="subtitle"',
        'selectedSubtitleText.addEventListener("input"',
        'id="text-style-inspector"',
        'id="text-font-size"',
        'id="text-position-x"',
        'id="apply-style-all-btn"',
        "ensureCurrentStyleOverride",
        ...
        'completeReviewBtn.dataset.status = "needs_review"',
        'aria-pressed="false"',
